...
export default function WhitePaperPage() {
  return (
    <SiteShell>
      <main
        style={{ maxWidth: 900, margin: "0 auto", padding: "160px 24px", lineHeight: 1.8 }}
        className="documention-content"
      >
        <h1>White Paper</h1>
        <p>
          <strong>BC ERA</strong>
        </p>
        ...
        <p>
          ...
          as staking incentives and value-driven participation—further empowers consumers, increasing engagement
        ...
        <ol>
          ...
          <li>Roadmap</li>
          <li>Team</li>
          <li>Governance and Strategic Framework</li>
        ...
        <h2>Who We Are</h2>
        <p>
          Based in the Philippines, BC ERA is a modern technology firm with a rich history in creating scalable,
          adaptable, user-centric online store solutions. Originally founded by a group of forward-looking
          enthusiasts eager about fostering innovation, our firm has regularly produced customized solutions fit
          for the changing needs of worldwide digital commerce. But seeing the unrealized potential and disruptive
          power of blockchain technology, we have started a revolution that connects the unmatched powers of
          distributed networks with conventional e-commerce. This audacious shift confirms our leadership as
        ...
        <p>
          Why is the time for this change right now? Although the global e-commerce is expected to reach
          $7.4 trillion by 2025, the industry is facing increasing difficulties according to statistics. Now
          charging fees ranging from 2.9% to 5% of transactions, payment processors and middlemen greatly reduce
          profits. Concurrently, restricted global reach of small firms globally still results from technology
          obstacles and tight restrictions. Data leaks exacerbate already existing problems; an estimated
          22 billion data were revealed in hacks in 2022 alone, highlighting the inadequacies of centralized
          security mechanisms.
        </p>
        <p>
        ...
        <p>
          ...
          new benchmark whereby companies flourish, consumers get recognition, and innovation propels significant
          transformation of the world economy.
        </p>

        <h2>Problem Statement</h2>

        <h3>High Transaction Charges</h3>
        <p>
          With e-commerce expected to reach $7.4 trillion in worldwide revenue by 2025, its fast expansion has
          changed the retail scene and made online buying second nature in modern living. Still, the sector
          struggles with fundamental issues that compromise security, inclusiveness, and efficiency even with
          growth.
        </p>
        <p>
          Payment gateways and e-commerce sites mostly rely on middlemen, especially banks and outside processors
          who apply transaction fees averaging between 2.9% and 5%. For vendors, especially small businesses,
          this means declining profit margins. Higher product prices help customers to indirectly pay for these
          expenses. These fees cost billions in lost value annually, therefore impeding development for companies
          with already limited margins.
        </p>

        <h3>Privacy and Data Security Risks</h3>
        <p>
          One of the primary weaknesses still in e-commerce is data centralization. With 22 billion records
          exposed in data breaches in 2022 alone, cyberattacks keep getting more severe worldwide. From payment
          credentials to personal identities, sensitive consumer data is kept in readily accessible centralized
          systems, increasing users&apos; vulnerability to fraud and theft. Such violations compromise not only
          confidence but can lead to legal fines and damage to corporate reputation.
        </p>

        <h3>Restricted Worldwide Accessibility</h3>
        <p>
          Though the internet is global, geographical restrictions and antiquated payment systems constrain
          traditional e-commerce. Globally, about 1.4 billion individuals still lack bank accounts; fees, poor
          currency conversion rates, and platform exclusivity limit access to online markets. For companies,
          these obstacles prevent prospects in developing areas, therefore underserving billions of prospective
          consumers.
        </p>

        <h3>Lack of User-Driven Rewards</h3>
        <p>
          While consumers—those in charge of the expansion of the platform—receive little to no reward for their
          loyalty or involvement, centralized markets give businesses power. Platforms lack strong incentive
          systems or engagement tools; the ones that do exist usually have inadequate organization or one-sided
          design. Lack of user-driven incentives stunts consumer retention, lowers community involvement, and
          hinders long-term business development.
        </p>
        ...
        <p>
          The e-commerce sector is changing fundamentally and altering customer interaction with goods and
          services as well as corporate operations. Driven by fast digitalization, changing customer expectations,
          and major technology developments, the industry has become a pillar of the modern worldwide economy.
          Though there are many possibilities, the terrain is also full of complexity that calls for creative,
          forward-looking answers.
        </p>

        <h3>The Unstoppable Growth of E-commerce</h3>
        <p>
          Among the domains of the digital economy, e-commerce is among the quickest growing. Industry estimates
          show that global retail e-commerce revenues will rise substantially through the coming years, with an
          increasing share of total retail sales happening online, showing a substantial customer inclination for
          digital buying compared to traditional retail.
        </p>
        <p>There are several underlying causes for this momentum:</p>
        <ul>
          <li>Convenience and Accessibility</li>
          <li>Widespread Internet connectivity</li>
          <li>Changing Customer Demand</li>
        </ul>

        <h3>Emerging Markets as Growth Accelerators</h3>
        <p>
          Globally expanding e-commerce depends critically on emerging markets. Online retail usage is rising in
          economies such as India, Brazil, Indonesia, and areas of Africa. A growing middle class, more
          acceptance of mobile internet, and extensive digital payment systems are a few of the several elements
          driving this development.
        </p>
        <p>
          Further complementing this expansion are the worldwide spread of digital payment options like e-wallets,
          cryptocurrencies, and buy now, pay later programs. These developments simplify user experiences, speed
          transactions, and enable even non-banked people to engage in the digital economy.
        </p>

        <h3>Challenges in the E-commerce Ecosystem</h3>
        <ul>
          <li>High Transaction Costs</li>
          <li>Security and Fraud Risks</li>
          <li>Cross-Border Inefficiencies</li>
          <li>Limitations in Supply Chain Transparency</li>
        </ul>

        <h3>Blockchain and Cryptocurrency as Solutions</h3>
        <ol>
          <li>Reduced Transaction Costs</li>
          <li>Enhanced Security</li>
          <li>Enabling Seamless Cross-Border Payments</li>
          <li>Smart Contracts for Transparency</li>
        </ol>

        <h3>Emerging Technologies Reshaping E-commerce</h3>
        <p>
          Beyond blockchain and cryptocurrency, innovations like Artificial Intelligence (AI) and the Internet of
          Things (IoT) are revolutionizing the e-commerce space.
        </p>
        <ul>
          <li>Personalization Engines</li>
          <li>Intelligent Search</li>
          <li>Chatbots and Virtual Assistants</li>
          <li>Smart Shelving and Inventory</li>
          <li>Logistics Optimization</li>
          <li>Fraud Detection and Credit Scoring</li>
        </ul>

        <h3>The Road Ahead for E-commerce</h3>
        <p>
        ...
        <ul>
          ...
          <li>Omnichannel Evolution</li>
        </ul>

        <h2>Industry Challenges</h2>
        <p>
          The e-commerce industry keeps growing, but it is not without major structural problems too. Many times,
          these obstacles limit efficiency, lower profitability, and jeopardize long-term development.
        </p>

        <h3>High Transaction Fees</h3>
        <p>
          Whether they are payment processors, banks, or platform operators, traditional e-commerce operations
          depend mostly on middlemen. For every sale, these middlemen often charge transaction fees ranging from
          2% to 5%. Small and medium-sized companies find it difficult to stay competitive as these fees
          compromise already narrow profit margins.
        </p>

        <h3>Limited Engagement Through Loyalty Programs</h3>
        <p>
          While numerous platforms use loyalty programs to encourage repeat commerce, these projects can fall
          short of their promise. Current systems lack significant rewards and personalizing ability, which
          results in average user involvement.
        </p>

        <h3>Data Security Concerns</h3>
        <p>
          Centralized platforms also present inherent risks when it comes to data security. Cyberattacks targeting
          key infrastructure frequently result in sensitive consumer and business data being compromised.
          Centralization amplifies this vulnerability, leaving platforms more exposed to coordinated hacking
          efforts.
        </p>

        <h2>Blockchain&apos;s Transformative Role in E-commerce</h2>
        <p>
          Blockchain technology offers powerful solutions to the systemic inefficiencies and hurdles plaguing
          traditional e-commerce. By decentralizing critical processes and leveraging advanced cryptographic
          techniques, blockchain-enabled platforms lay the foundation for a more efficient, secure, and
          consumer-focused retail landscape.
        </p>

        <h3>Transparent and Fair Transactions</h3>
        <p>
          At the heart of blockchain technology lies the immutable digital ledger. This innovation fosters
          unprecedented levels of transparency in financial transactions. Unlike traditional platforms where
          intermediary disputes are common, blockchain&apos;s tamper-proof design ensures every transaction is
          verifiable and irreversible, eliminating gray areas and improving trust between buyers and sellers.
        </p>

        <h3>Reduction in Operational Costs</h3>
        <p>
          Blockchain significantly reduces operational overhead by eliminating intermediaries. Smart contracts—a
          core feature of blockchain—automate the execution of agreements, efficiently replacing third-party
          services.
        </p>

        <h3>Enhanced Security and Fraud Prevention</h3>
        <p>
          Security is a defining attribute of blockchain technology. Transactions are encrypted, distributed
          across decentralized networks, and verified through consensus algorithms, making it nearly impossible
          for malicious actors to alter records.
        </p>

        <h3>Improved Customer Engagement Through Tokenization</h3>
        <p>
          Blockchain also enables the tokenization of loyalty programs, offering customers greater flexibility,
          personalization, and incentivization. Retailers can create branded, tradeable tokens that can be
          redeemed across ecosystems, enhancing user engagement and driving greater customer retention.
        </p>
        ...
        <p>
          E-commerce&apos;s rise shows no signs of slowing, but the industry&apos;s evolution depends on addressing
          its longstanding inefficiencies. Blockchain is poised to be the defining technology of this new era,
          offering scalable solutions that empower businesses, engage consumers, and fortify security.
        </p>
        ...
        <h3>Key Features and Roles</h3>
        <ul>
          <li>Payments and Transactions</li>
          <li>Dynamic Discounts and Loyalty Rewards</li>
          <li>Staking for Passive Income</li>
          <li>Governance and Platform Decisions</li>
          <li>Creating Opportunities for Financial Growth</li>
        </ul>

        <h3>Token Distribution</h3>
        <ul>
          <li>20% Public Sale</li>
          <li>20% Team and Operations</li>
          <li>40% Staking and Rewards</li>
          <li>10% Marketing</li>
          <li>10% Reserve</li>
        </ul>
        ...
        <h2>Roadmap</h2>
        <p>
          <strong>Phase 1: Laying the Foundation</strong> — platform development, pre-sale activities, and beta
          launches.
        </p>
        <p>
          <strong>Phase 2: Public Launch and Ecosystem Activation</strong> — user access and staking
          functionalities rollout.
        </p>
        <p>
          <strong>Phase 3: Governance and Market Expansion</strong> — DAO introduction and global marketing
          campaigns.
        </p>
        <p>
          <strong>Phase 4: Global Technological Leadership</strong> — expansion into underserved markets and
          deployment of AI-driven personalization features.
        </p>

        <h2>Team</h2>
        <p>
          Any project&apos;s success rests in the team&apos;s strength and experience. The platform&apos;s mission is
          driven into reality by a multitude of expertise, technological knowledge, and proven success.
        </p>
        ...
        <ul>
          <li>30% Platform Development</li>
          <li>20% Marketing & Partnerships</li>
          <li>20% Reserve Fund</li>
          <li>20% Tokenomics (Staking & Rewards)</li>
          <li>10% Legal & Operational Costs</li>
        </ul>

        <h2>Future Vision</h2>
        <p>
          The future vision includes AI-powered personalization, expanded DeFi functionalities such as lending,
          borrowing, and yield farming, and positioning the platform for leadership in blockchain-enabled digital
          commerce.
        </p>
